...
<div id="wrap">
  <div id="menu">
    ...
    <div id="best">
    	<a>
    		<img src="image/menu_12.png" name="best" width="390" height="46" id="best" onmouseover="MM_swapImage('best','','image/mmenu_12.png',1)" onmouseout="MM_swapImgRestore()" />
    	</a>
    </div>
    <div id="outer">
    	<a href="categoryType.jsp?type=1">
    ...
    <div id="top">
    	<a href="categoryType.jsp?type=2">
    ...
    <div id="skirt">
    	<a href="categoryType.jsp?type=3">
    ...
    <div id="pants">
    	<a href="categoryType.jsp?type=4">
    ...
    <div id="dress">
    	<a href="categoryType.jsp?type=5">
...
<div id="right">
   <%
    ...
    <div id="switch"><img src="image/switch1.png" name="switch" width="1510" height="725" id="switch" />
     <div class="imgmenu">
        <ul>
              <li><a href="categoryType2.jsp" onMouseOver="MM_swapImage('switch','','image/switch1.png',1)" onmouseout="MM_swapImgRestore()">STRIPE</a></li>
              <li><a href="categoryType2.jsp" onMouseOver="MM_swapImage('switch','','image/switch2.png',1)" onmouseout="MM_swapImgRestore()">TOP</a></li>
              <li><a href="categoryType5.jsp" onMouseOver="MM_swapImage('switch','','image/switch3.png',1)" onmouseout="MM_swapImgRestore()">DRESS</a></li>
        </ul>
      </div>
