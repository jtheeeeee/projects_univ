...
<div id="wrap">
  ...
  <div id="right">
    ...
    <div id="switch">
     ...
     %>
  <form action="noticeWriteConfirm.jsp" method="post" name="form1">
                    <table width="680" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      <tr>
                        <th><label for="noticeTitle">* 제목</label></th>
                        <td>
                        <input name="noticeTitle" type="text" id="noticeTitle" size="70"/></td>
                      </tr>
                      <tr>
                        <th><label for="userId">* 작성자 아이디</label></th>
                        <td>
                   <input name="userId" type="text" id="userId" size="70"/>
                       </td>
                      </tr>
                      <tr>
                        <th><label for="noticeContent">* 내용</label></th>
                        <td>
                   <input name="noticeContent" type="text" id="noticeContent" size="70"/>
                       </td>
                      </tr>
                      <tr>
