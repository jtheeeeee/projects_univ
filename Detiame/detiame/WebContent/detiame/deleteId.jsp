...
<div id="wrap">
  ...
  <div id="tabpanelbg">
    ...
    <p></p>
  		...
  		%>
      <div id="delete1">회원 탈퇴 이유를 적어주세요..</div>
      <div id="deleteMain">
     <textarea name="deleteReason" cols="100" rows="7">
     </textarea>
      </div>
        ...
        <div id="bottom1">
          <div id="modifyBottom">
            <form id="form3" name="form3" method="post" action="">
              <input type="submit" name="reset" id="reset" value="취소" />
            </form>
          </div>
        </div>
        <div id="bottom2">
          <div id="submit">
            <form id="form2" name="form2" method="post" action="delete.jsp">
              <input type="submit" name="submit" id="submit2" value="전송" />
            </form>
          </div>
