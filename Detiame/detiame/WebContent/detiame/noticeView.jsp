...
<div id="wrap">
  ...
  <div id="tabpanelbg">
    ...
    <div id="tabpanel"><img src="image/notice.jpg" width="921" height="71" /></div>
    <div id="content">
     <%
  ...
  try{
   ...
   NoticeDao dao= new NoticeDao();
      noticeList = dao.selectListByNoticeId(conn, noticeId);
    ...
    <c:forEach var="notice" items="${list}">
      ...
      <table width="800" border="1" align="center" cellpadding="3" cellspacing="0" ">
        <tr>
          ...
          <td width="600">${notice.noticeTitle}</td>
        </tr>
        <tr>
