  ...
  <div id="tabpanelbg">
    ...
    <div id="content">
      <div id="infoImage">
                  ...
                  <form name="form1" method="post" action="infoModifyForm.jsp">
          
                    <table width="750" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      
                      <tr>
                        <th><label for="pwfield">* P/W</label></th>
                        <td><label for="pwfield"></label>
                        <input type="password" id="password"  name="password" class="input-text" placeholder="비밀번호" maxlength="20" onfocusout="validatePassword()" /></td>
                      </tr>
                        <tr>
                        <th><label for="pwfield">* P/W 확인</label></th>
                        <td><label for="pwfield"></label>
                      <input type="password" id="check_password" class="input-text" placeholder="비밀번호 재확인" maxlength="20" onfocusout="validatePassword()"></td>
                      </tr>
                      <tr>
                        ...
                        <select name="email_field" id="email_field">
                      ...
                      <tr>
                        <th>* 연락처</th>
                        <td><p><input name="phone" type="text" />
                      ...
                      <tr>
                        ...
                        <textarea name="userAddress" id="userAddress" cols="45" rows="5"></textarea></td>
                      </tr>
                  
                      <tr>
                        <td height="30" colspan="2" align="center" class="btnstyle"><div class="buttonForm">
                          <input type="submit" name="submit" id="submit" value="전송" />
                        </div></td>
                      </tr>
                    </table>
                  </form>
