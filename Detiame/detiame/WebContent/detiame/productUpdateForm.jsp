...
<div id="wrap">
  ...
  <div id="right">
    <div id="logo"><img src="image/logo-gray.png" width="1510" height="270" /></div>
    	<form action="productUpdate.jsp" method="post" enctype="multipart/form-data" name="form1">
    	<%
                  ...
                  <form action="productUpdate.jsp" method="post" enctype="multipart/form-data" name="form1">
                    <table width="680" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      <tr>
                        ...
                        <td>
                        <input name="productName" type="text" value="${product.productName}" size="70"/></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th><label for="productType">* 제품 유형</label></th>
                        <td>
                			<input name="productType" type="text" value="${product.productType}"/>
                       </td>
                      </tr>
                      <tr>
                        <th><label for="productImage">* 파일첨부</label></th>
                        <td><input type="file" name="productImage" value="${product.productImage}"/></td>
                      </tr>
                      <tr>
                        <td height="30" colspan="2" align="center" class="btnstyle">
                        	<input type="submit" name="btn" id="btn" value="확인"/>
