...
<div id="wrap">
  <div id="menu">
    ...
    <div id="best"></div>
    <div id="outer"><img src="image/menu_13.png" name="outer" width="390" height="53" id="outer" /></div>
  ...
  <div id="right">
    ...
    <div id="bg">
    <div id="bgcolor">
      <div id="sbag"><img src="image/order1.png" name="order" width="142" height="43" id="order" /></div>
...
<div class="buttonForm">
 <a href="purchase.jsp">
  <input name="submit" type="button" value="주문하기" />
 </a> 
</div>
