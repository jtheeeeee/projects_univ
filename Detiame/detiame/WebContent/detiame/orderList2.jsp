 ...
 %>
      ...
      <table width="814" border="1" align="center" cellpadding="10" cellspacing="0">
        ...
        <tr>
          ...
          <td><input type="radio" name="modify" id ="radioRemove" value="${purchase.purchaseId }"/></td>
          <td><div class="buttonForm">
             
              <input type="button" name="reset" id="reset" value="주문취소" onclick = "remove()" class="buttonForm"/>
      ...
      <div class="gotoMainForm">
      	<form id="form5" method="post" action="mainPage2.jsp">
...
function remove(){
	var purchaseId = document.getElementById("radioRemove").value.trim();
	location.href='purchaseDelete.jsp?purchaseId='+purchaseId;
}
