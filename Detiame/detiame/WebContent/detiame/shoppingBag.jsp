...
<div id="wrap">
 ...
 %>
      ...
      <table width="814" border="1" align="center" cellpadding="10" cellspacing="0">
        <tr>
          <th width="45" scope="col">번호</th>
          <th width="125" scope="col">제품명</th>
          <th width="90" scope="col">수량</th>
          <th width="90" scope="col">가격</th>
          <th width="90" scope="col">선택</th>
          <th width="90" scope="col">변경</th>
          <th width="90" scope="col">구매</th>
          <th width="90" scope="col">취소</th>
        </tr>
        ...
        <tr>
          ...
          <td>${cart.amount }</td>
          <td>${cart.price }</td>
          <td><input type="radio" name="modify" id ="radioModify" value="${cart.cartId }"/></td>
          <td><div class="buttonForm">
          	<input type="button" name="modify" id="modify" onclick= "modify()" value="변경" class ="buttonFrom" />
          </div></td>
          <td><div class="buttonForm">
          	<input type="button" name="modify" id="modify" onclick= "purchase()" value="구매" class ="buttonFrom" />
          	<input type="hidden" name ="productId" id="productId" value="${cart.cartId }"></input>
          	<input type="hidden" name ="amount" id="amount" value="${cart.amount }"></input>
          </div></td>
          <td><div class="buttonForm">
              <input type="button" name="reset" id="reset" value="삭제" onclick ="remove()"class="buttonForm"/>
          </div></td>
        </tr>
        </c:forEach>
      </table>
...
function modify(){
	var cartId = document.getElementById("radioModify").value.trim();
	location.href='shoppingBagModifyForm.jsp?cartId='+cartId;
}
function remove(){
	var cartId = document.getElementById("radioModify").value.trim();
	location.href='shoppingBagDelete.jsp?cartId='+cartId;
}
function purchase(){
	var cartId = document.getElementById("radioModify").value.trim();
	location.href='orderForm.jsp?cartId='+cartId;
}
