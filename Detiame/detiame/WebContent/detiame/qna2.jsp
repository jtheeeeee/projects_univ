...
<div id="wrap">
  <div id="menu">
    ...
    <div id="outer">
     <a href="categoryType6NoLogin.jsp">
    ...
    <div id="top">
     <a href="categoryType7NoLogin.jsp">
    ...
    <div id="skirt">
     <a href="categoryType8NoLogin.jsp">
    ...
    <div id="pants">
     <a href="categoryType9NoLogin.jsp">
    ...
    <div id="dress">
     <a href="categoryType10NoLogin.jsp">
  ...
  <div id="right">
    ...
    <div id="bgcolor">
      <div id="sbag">
       <a href="shoppingBag.jsp">
        <img src="image/mypage/mypage_03.png" width="142" height="43" />
       </a>
      </div>
      <div id="orderList">
       <a href="orderList.jsp">
        <img src="image/mypage/mypage_04.png" width="106" height="43" />
       </a>
      </div>
      <div id="qnalist">
       <a href="qna.jsp">
        <img src="image/mypage/f2_05.png" name="qnalist" width="102" height="43" id="qnalist2" onmouseover="MM_swapImage('qnalist','','image/mypage/f2_05.png',1)" onmouseout="MM_swapImgRestore()" />
       <a>
      </div>
      <div id="myInfoModify">
  ...
  <div id="tabpanelbg">
    ...
    <div id="tabpanel"><img src="image/mypage/qna.png" width="921" height="71" /></div>
    <div id="content">
      <div id="qna1">
        <p>고객님들이 궁금해하고 질문하는 사항들을 모았습니다.</p>
        <p>1. 교환 반품 안내</p>
        <p>수령이후 3일이내로 이메일(jetaimeqna@gmail.com) 로 연락주세요~<br />
        </p>
        <p>[변심으로 인한 교환/반품]<br />
          7일이내에 Je t'aime에 상품이 도착되어야합니다~<br />
          (연휴,픽업지연등으로 인해 늦어지는 경우를 제외하고 다른 사유인 경우 반품처리가 어려울 수 있습니다.)<br />
          우체국택배(1588-1300) 착불로 보내주시구요~</p>
        <p>2. 배송기간안내          </p>
        <p>Je t'aime의 상품은 평균적으로 주문일로부터 약 2 ~ 3 일째 발송됩니다.<br />
          상품의 재고확보 상황에 따라서 평균배송기간보다 조금 더 걸릴수도 있습니다.<br />
          이점은 항상 양해를 부탁드리겠습니다.        
        <p>        
        <p>그 밖의 모든 문의는 이메일(jetaimeqna@gmail.com)로 연락주세요~              </div>
        <p>&nbsp;</p>
        <div class="gotoMainForm">
        <form action="mainPage2.jsp" method="post">
