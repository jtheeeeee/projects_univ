...
<%
 ...
 try{
  product = new Product();
  dao = new ProductDao();  
  productList = dao.selectListSearch(conn, keyword);
...
<div id="right">
 ...
 <div id="tabpanelbg">
    <div id="tabpanel"><img src="image/mypage/searchList.jpg" width="921" height="71" /></div>
 <div class="product_content12">
      <c:set var="list" value="<%=productList %>"/>
      <table width="814" border="1" align="center" cellpadding="10" cellspacing="0">
        <tr>
          <th width="90" scope="col">제품명</th>
          <th width="125" scope="col">가격</th>
          <th width="90" scope="col">색상</th>
          <th width="90" scope="col">이미지</th>
        </tr>
        ...
        <tr>
          ...
          <td>${product.price }</td>
          <td>${product.color }</td>
          <td><a href="productSearch.jsp?productName=${product.productName}">
