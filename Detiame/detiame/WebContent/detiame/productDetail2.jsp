 ...
 <% 
    ...
    <div class="product">
      <div id="product_detail">
        ...
        <div id="choice">
          <div id="buy">
            <a href="productUpdateForm.jsp?productId=${product.productId}&productName=${productName}&color=${color}&price=${product.price}&productImage=${productImage}">
            		<input type="button" onclick="productUpdate()" name="update" id="buy" value="update" />
            </a>
          ...
          <div id="buy">
            ...
            <input type = "button" id = "buy" onclick= "productDelete()" value="delete"></input>
...
function productUpdate(){
	...
	location.href='productUpdateForm.jsp?productId='+productId+'&productName='+productName+'&color='+color+'&price='+price+'&productImage'+productImage;
}
function productDelete(){
	var productId = document.getElementById("productId").value.trim(); //꼭 해줘야 함. 숫자라서 공백 문자가 필요하지 않기 때문에!!!!!!!
	location.href='productDelete.jsp?productId='+productId;
}
</script>
</body>
</html>
