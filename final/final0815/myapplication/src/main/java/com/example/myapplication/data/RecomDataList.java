...
public class RecomDataList  implements Serializable {
    ...
    public RecomDataList(int products_id, String products_name, String origin, String cat_or_dog, String age_contraction, String food_sort, int price, String manufacturer_contraction, String animal_sort){
